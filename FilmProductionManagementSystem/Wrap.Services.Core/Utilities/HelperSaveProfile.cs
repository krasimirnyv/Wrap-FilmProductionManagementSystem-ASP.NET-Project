...
internal static class  HelperSaveProfile
{
    ...
    internal static async Task<string> SaveProfileImageAsync(IWebHostEnvironment environment, IFormFile? photo, CancellationToken cancellationToken = default)
    {
        ...
        using (image)
        {
            ...
            {
                Size = new Size(OutputSizeProfileImage, OutputSizeProfileImage),
